...
$contact6 = curl_wrap("contacts/update/properties", $contact_json_partial_update1, "PUT", "application/json");
echo $contact6;
...
curl_wrap("contacts/add-star", $contact_json_star_input, "PUT", "application/json");

// **************************Add score to a contact by email ****************
...
$contac7 = curl_wrap("contacts/add-score", rtrim($fields_string, '&'), "POST", "application/x-www-form-urlencoded");
